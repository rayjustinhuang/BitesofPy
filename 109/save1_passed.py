...
def get_workout_motd(day):
    ...
    if titleday in workout_schedule.keys():
        if titleday not in ['Saturday', 'Sunday']:
            return go_train.format(workout_schedule[titleday])
        else:
            return chill
    else:
        raise KeyError("That is not a valid day")
    pass

#print(get_workout_motd('Friday'))
#print(get_workout_motd('Saturday'))
#print(get_workout_motd('Fire'))